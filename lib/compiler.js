...
compiler.prototype.default_open_file = function(file){
    var path = this.path;
    var data;
    if (typeof jQuery !== 'undefined'){
        ...
        //TODO: require_js says that it is not nice!
        var fs = require('fs');
        //TODO: fix this static
        data = fs.readFileSync(path + file, 'binary');
    }
    return data;
};

compiler.prototype.set_open_file_handle = function(file_handle){
    this._file_handle = file_handle;
};

compiler.prototype.open_file = function(file){
    return this._file_handle(file);
};
...
_compiler._file_handle = compiler.prototype.default_open_file;
return _compiler;
