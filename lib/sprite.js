...
sprite.prototype.open_file = function (file){
	var fs = require('fs');
	return fs.readFileSync(file, 'binary');
};

sprite.prototype.open_file_with_jquery = function (file, jQuery) {
	var content;
	jQuery.ajax({
            url: file,
            xhr: function() {
...
sprite.prototype.load_sprites = function(file){
    ...
    if (typeof jQuery !== 'undefined'){
        chr = this.open_file_with_jquery(file, jQuery);
    } else {
        chr = this.open_file(file);
    }
    var sprites = [];
