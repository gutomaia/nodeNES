...
define([
    ...
    'bootstrap'
    // TODO: 'asm'
    ], function($, _, Backbone, CodeMirror, JSNES, compiler, sprite, ui, utils) {
...
var ide = {
    ...
    init: function(){
        ...
        utils.default_open_file = utils.open_file;
        utils.open_file = ide.utils_open_file;
    ...
    load_file: function(file){
        $.get(file, function(data) {
            ...
            if (m) {
                ...
                ide.codemirror.refresh();
            }
        });
    },
    utils_open_file: function(file){
        ide.files_opened.push(file);
        if (loader.file == file){
            return String.fromCharCode.apply(undefined, loader.sprites);
        } else {
            return utils.default_open_file(file);
        }
    }
};
    ...
    var UI = function(nes) {
        ...
        */
        this.dynamicaudio = new DynamicAudio({
            swf: nes.opts.swfPath+'/component/jsnes/swf/dynamicaudio.swf'
        });
    };
